...
func (tr *traceReader) EventID() tracetypes.EventID {
	return tracetypes.EventID(tr.UVarint())
}
...
func (tr *traceReader) FromVer(version tracetypes.Version) versionFilterReader {
